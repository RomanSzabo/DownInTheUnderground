...
public class DatabaseInitializer {
    ...
    private static void populateWithData (StationDB db) {
        Exit e[] = new Exit[] {new Exit(1, 1, "Venediger Au", true, 3, "b"),
                               new Exit(1, 2, "Praterstern",true, 2, "f"),
                               new Exit(2, 3, "Novaragasse",true, 4, "b"),
                               new Exit(2, 4, "Taborstrasse",true, 4, "f"),
                               new Exit(3, 5, "Herminengasse",true, 4, "b"),
                               new Exit(3, 6, "Schottenring",true, 4, "f"),
                               new Exit(4, 7, "Hohenstraufengasse",false, 2, "b"),
                               new Exit(4, 8, "Universitaetsring(Universitaet)",true, 1, "f"),
                               new Exit(5, 9, "Florianigasse",false, 1, "b"),
                               new Exit(5, 10,"Josefstaedter Strasse, Landesgerichtsstrasse",true, 1, "f"),
                               new Exit(5, 11,"Friedrich-Schmidt-Platz, Rathaus",false, 1, "b"),
                               new Exit(5, 12,"Josefstaedter Strasse, Stadiongasse",true, 1, "f"),
        };
